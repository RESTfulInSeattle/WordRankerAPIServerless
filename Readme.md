...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *WordRankerAPIServerless*):

Restore dependencies
```
    cd "WordRankerAPIServerless"
    dotnet restore
```

Execute unit tests
```
    cd "WordRankerAPIServerless/test/WordRankerAPIServerless.Tests"
    dotnet test
```

Deploy application
```
    cd "WordRankerAPIServerless/src/WordRankerAPIServerless"
